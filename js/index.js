...
const HELPERS = {
  ...
  establecer_datos() {
    ...
    const pago_ahorro_mensual_familiar = !plan_sugerido_cdp1 ? 0 : Number(pago_sin_descuento - pago_con_descuento);
    ...
    switch (plan_sugerido_linea_adicional) {
      case "ENTEL POWER 44.90 C":
        plan_sugerido_linea_adicional_2 = "ENTEL POWER FAMILIAR+ 39.90";
        break;
      case "ENTEL POWER 54.90 C":
        plan_sugerido_linea_adicional_2 = "ENTEL POWER FAMILIAR+ 49.90";
        break;
      case "ENTEL POWER 69.90 C":
        plan_sugerido_linea_adicional_2 = "ENTEL POWER FAMILIAR+ 63.90";
        break;
      case "ENTEL POWER 79.90 SD C":
        plan_sugerido_linea_adicional_2 = "ENTEL POWER FAMILIAR+ 74.90";
        break;
      case "ENTEL POWER 99.90 SD C":
        plan_sugerido_linea_adicional_2 = "ENTEL POWER FAMILIAR 94.90 SD";
        break;
      case "ENTEL POWER 129.90 SD C":
        plan_sugerido_linea_adicional_2 = "ENTEL POWER FAMILIAR 115.90";
        break;
      case "NO APLICA":
        plan_sugerido_linea_adicional_2 = "NO APLICA";
        break;
      default:
        plan_sugerido_linea_adicional_2 = "-";
    }

    document.querySelector("#txt_plan_sugerido_linea_adicional2").value = plan_sugerido_linea_adicional_2;
  },
